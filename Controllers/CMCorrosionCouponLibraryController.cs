...
namespace CPOC_AIMS_II_Backend.Controllers
{
	...
	public class CMCorrosionCouponLibraryController : ControllerBase
	{
		...
		public async Task<ActionResult<IEnumerable<CMCorrosionCouponLibrary>>> GetCMCorrosionCouponLibraryByTag(int id_tag)
		{
			return await _context.CMCorrosionCouponLibrary.Where(b => b.id_tag == id_tag).ToListAsync();
		}
